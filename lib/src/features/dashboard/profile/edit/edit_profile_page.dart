...
class EditProfilePage extends GetView<EditProfileController> {
            ...
            child: Column(
              children: [
                ...
                Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      onChanged: (value) {
                        controller.setFormValidity(value);
                      },
                    ),
                  ],
                ),
                        ...
                        prefixIcon: const Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '+62',
                                style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: gray900),
                              ),
                              SizedBox(width: 12),
                              SizedBox(
                                width: 1.5,
                ...
                Obx(() => Row(
                      children: [
                        Expanded(
                          child: outlinedButtonSwitch('Male', !controller.isGenderFemale, () {
                            controller.onChangeGender(false);
                          }),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: outlinedButtonSwitch('Female', controller.isGenderFemale, () {
                ...
                SizedBox(
                    ...
                    child: Obx(
                      () => ButtonIcon(
                        buttonColor: controller.isFormValid ? primary : gray600,
                        textColor: white,
                        textLabel: "Save Changes",
                        onClick: () {
                          controller.isFormValid ? controller.saveData() : print('true');
                          //  controller.saveData();
                        },
                      ),
                    )),
  ...
  Widget outlinedButtonSwitch(String label, bool active, onClick) => OutlinedButton(
        style: OutlinedButton.styleFrom(
            padding: EdgeInsets.zero,
            backgroundColor: active ? primary.withOpacity(0.1) : white,
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(100)),
            side: BorderSide(width: active ? 0.0 : 1.5, color: active ? white : gray200)),
        onPressed: () {
          onClick();
        },
        child: Padding(
