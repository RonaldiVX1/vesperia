...
class ProductListPage extends GetWidget<ProductListController> {
  ...
  Widget buildProductList(BuildContext context) => DynamicHeightGridView(
      ...
      builder: (context, index) {
        ...
        return Container(
          margin: EdgeInsets.only(left: index % 2 == 0 ? 24 : 0, right: index % 2 == 0 ? 0 : 24, bottom: index == controller.products.length - 1 ? 16 : 0),
                    ...
                    children: [
                      AspectRatio(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: product.images?.isNotEmpty == true ? product.images![0].urlSmall ?? '' : '',
                          fit: BoxFit.cover,
                        ...
                        children: [
                          InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Obx(
                                  () => Image.asset(
                                    product.isFavorite ? ic_favorite_filled : ic_favorite_empty,
                                    width: 24,
                                    height: 24,
                                  ),
                                ),
